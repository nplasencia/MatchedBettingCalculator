...
final class MarketTypeTypeTest extends TestCase
{
    private MarketTypeType $type;
    ...
    protected function setUp(): void
    {
        ...
        $this->type = new MarketTypeType($this->router, $this->translator);
    }

    public function testBuildForm_success(): void
    {
        $routeName = 'store_marketType';
        ...
        $builder->expects($this->exactly(3))->method('add')
            ->withConsecutive(
                ...
                ['code', TextType::class, ['required' => true]],
